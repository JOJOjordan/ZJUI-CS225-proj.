...
public:
    ...
    void addall2(T item, edgelist<T> * pt);
private:
    neighbour<T> *first;
    int length;
};
...
public:
    ...
    void insert_edge(T origin, T destination);
    void insert_vertex(T item, int Vx);
    void delete_edge(T origin, T destination);
    void delete_vertex(T item);
    void prettyprint(void); // only for testing
    edgelist<T> * incident_edges(T item);
    void is_perfect_match(void);
    void recursion1(void);
    void recursion2(void);
private:
    vertexlist<T> * vertices;
    vertexlist<T> *V1;
    vertexlist<T> *V2;
